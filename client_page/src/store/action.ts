...
export default {
    ...
    saveBannerSider(context: any, paylod: BannerSider) {
        http.post('/config/setBannerSider', paylod).then((res:Response) => {
            message.success(res.data)
    ...
    saveSupportPay(context: any, paylod: SupportPay) {
        http.post('/config/setSupportPay', paylod).then((res:Response) => {
            message.success(res.data)
    ...
    editArticle(context: any, paylod: any) {
        return new Promise((resolve:any, reject:any) => {
            http.post('/article/editArticle', paylod).then((res:Response) => {
    ...
    delArticle(context: any, paylod: any) {
        return new Promise((resolve:any, reject:any) => {
            http.del('/article/delArticle', {id:paylod.id}).then((res:Response) => {
    ...
    getAdmins(context: any) {
        http.get('admin/all').then((res:Response) => {
    ...
    addAdmin(context: any, paylod: any) {
        return new Promise((resolve:any, reject:any) => {
            http.post('admin/addAdmin', paylod).then((res:Response) => {
    ...
    editAdmin(context: any, paylod: any) {
        return new Promise((resolve:any, reject:any) => {
            http.post('admin/editAdmin', paylod).then((res:Response) => {
    ...
    delAdmin(context: any, paylod: string) {
        http.del('admin/delAdmin', {name: paylod}).then((res:Response) => {
